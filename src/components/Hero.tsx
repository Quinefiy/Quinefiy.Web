                ...
                <div data-delay="0" className={`opacity-0 animate-left-on-scroll flex flex-col lg:w-auto w-full xl:gap-[30px] lg:gap-[28px]  md:gap-[16px] sm:gap-[24px] gap-[12px]`}>
                    ...
                    <div className="">
                        <div className="flex flex-col gap-0">
                            <h1 className="text-[#E1E1E1] 2xl:text-[clamp(54px,3.5vw,70px)] xl:text-[clamp(48px,3.2vw,56px)] lg:text-[4vw] md:text-[clamp(28px,4.2vw,48px)] sm:text-[48px] text-[clamp(28px,8vw,48px)] font-bold 2xl:leading-[140%] leading-[130%] md:max-w-max max-w-[150px] ">{data.headingFirstWord} <span className="bg-gradient-to-b from-[#6BAAFF] to-[#DAEAFF] bg-clip-text text-transparent">{data.companyName}</span></h1>
                            <h1 className="text-[#E1E1E1] 2xl:text-[clamp(54px,3.5vw,70px)] xl:text-[clamp(48px,3.2vw,56px)] lg:text-[4vw] md:text-[clamp(28px,4.2vw,48px)] sm:text-[48px] text-[clamp(28px,8vw,48px)] font-bold 2xl:leading-[140%] leading-[130%]">{data.headingSecondPart}</h1>
                        </div>
                    </div>
                    ...
                    <Link href="/about-us" className=" max-w-fit relative mt-[20px]  text-hover-shadow group inline-block z-[1]">
                        ...
                        <p className="relative 2xl:text-[18px] xl:text-[17px] lg:text-[15px] md:text-[11.5px] sm:text-[18px] text-[16px] bg-gradient-to-b from-[#6BAAFF] to-[#DAEAFF] bg-clip-text text-transparent pointing cursor-pointer z-10">{data.aboutUsNavigateBtn}</p>
                    </Link>
                </div>
            </div>
