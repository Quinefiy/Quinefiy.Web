...
export default function Hero({data}: any) {
    ...
    // }
    // const { data, isSuccess } = useQuery({ queryKey: ['hero-data'], queryFn: getHeroSectionData })
            ...
            <div className="opacity-0 animate-hero-on-scroll flex flex-col self-end gap-[10px] mt-[60px] sm:w-auto w-[86%]">
                <div className="flex-1 relative xl:min-h-[300px] lg:min-h-[250px] md:min-h-[230px] sm:min-h-[250px] min-h-[39.2vw]">
                    ...
                    <motion.div
                        ...
                        <img src="/assets/processor-2.png" className="w-[50%]" />
                    </motion.div>
                    <motion.div
                        initial={{ scaleY: 0 }}
                        animate={{ scaleY: 1 }}
                    ...
                    <motion.div
                        ...
                        <img src="/assets/coding-gear.png" className="w-[50%] " />
                    </motion.div>
                    <motion.div
                        initial={{ scaleY: 0 }}
                        animate={{ scaleY: 1 }}
                    ...
                    <motion.div
                        ...
                        <img src="/assets/artificial-intelligence.png" className="w-[50%]" />
                    </motion.div>
                    <motion.div
                        initial={{ scaleY: 0 }}
                        animate={{ scaleY: 1 }}
