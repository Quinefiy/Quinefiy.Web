...
const Pricing = ({ data, showHeader }: Props) => {
    ...
    return (
        <div className="w-full max-w-[1535px] relative">
            ...
            <div className="w-full  flex lg:flex-row flex-col  justify-center items-center 2xl:gap-[24px] xl:gap-[18px] gap-[24px] flex-wrap ">
                {data?.pricingPlans.map((plan: any, index: number) => (
