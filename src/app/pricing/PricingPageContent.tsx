...
export default function PricingPageContent() {
    const { data, isLoading, isFetched } = useQuery({ queryKey: ["pricing-page-content"], queryFn: getPricingPageData });
    ...
    return (
        <div className=" !w-full flex flex-col xl:gap-[150px] md:gap-[120px] sm:gap-[80px] gap-[40px] items-center 2xl:px-[96px] xl:px-[52px] lg:px-[36px] md:px-[21px] sm:px-[19px] px-[16px] relative overflow-x-clip">
            ...
            <div className=" flex flex-col items-center lg:w-auto w-full lg:gap-[24px] md:gap-[22px] gap-[20px] 2xl:mt-[200px] xl:mt-[170px] md:mt-[150px] mt-[140px]">
                ...
                <h1 data-delay='0.2' className="opacity-0 animate-down-on-scroll text-[#E1E1E1] 2xl:text-[48px] xl:text-[42px] lg:text-[36px] md:text-[30px] sm:text-[24px] text-[20px] font-bold leading-[140%]">{data?.pricingHero.heading}</h1>
                <p data-delay='0' className="opacity-0 animate-down-on-scroll text-[#FFFFFFD9] xl:text-[18px] lg:text-[17px] md:text-[16px] sm:text-[15px] text-[14px] font-medium leading-[160%] lg:max-w-[722px] sm:max-w-[80%] text-center">{data?.pricingHero.subHeading}</p>
            </div>
            <div className="!w-full flex flex-col xl:gap-[150px] md:gap-[120px] sm:gap-[80px] gap-[40px] items-center relative max-w-[1535px] ">
                ...
                <Pricing data={data?.pricingPlans} showHeader={false} />
