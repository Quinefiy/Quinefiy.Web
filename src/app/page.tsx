  ...
  return (
    <div className=" w-full flex flex-col xl:gap-[150px] md:gap-[120px] gap-[80px] items-center 2xl:px-[96px] xl:px-[52px] lg:px-[36px] md:px-[21px] sm:px-[19px] px-[16px] ">
      <div className="w-full max-w-[1535px] flex md:flex-row flex-col-reverse lg:justify-between justify-center items-center mt-[100px] relative">
        ...
        <div data-delay="0" className="animate-left-on-scroll opacity-0 flex flex-col lg:w-auto w-full lg:gap-[24px] md:gap-[16px] sm:gap-[24px] gap-[12px]">
          <HeadingCard text="Best Quality" />
          <h1 className="text-[#E1E1E1] 2xl:text-[64px] xl:text-[60px] lg:text-[56px] md:text-[40px] sm:text-[48px] text-[32px] font-bold leading-[140%]">Quniefiy</h1>
          <p className="text-[#FFFFFFD9] 2xl:text-[28px] xl:text-[24px] lg:text-[20px] md:text-[16px] sm:text-[20px] text-[14px] font-medium leading-[150%] 2xl:max-w-[60%] xl:max-w-[450px] lg:max-w-[380px] md:max-w-[78%]" >“Your reliable partner in digital transformation , giving you confidence in comlex Quniefiy projects”</p>
          <div className="flex items-center xl:gap-[24px] md:gap-[10px] sm:gap-[18px] gap-[8px] mt-[12px]">
            <Link href='' className="blue-gradient h-[54px] px-[32px] xl:text-[18px] md:text-[14px] sm:text-[16px] text-[14px] font-bold text-[#FFFFFF] rounded-[16px] flex items-center justify-center whitespace-nowrap">Discover More</Link>
            <Link href='' className="blue-gradient h-[54px] xl:text-[18px] md:text-[14px] sm:text-[16px] text-[14px] font-bold text-[#FFFFFF] rounded-[16px] p-[1px]">
        ...
        <div className="opacity-0 animate-hero-on-scroll flex flex-col self-end gap-[10px] mt-[60px] sm:w-auto w-[86%]">
          <div className="flex-1 relative xl:min-h-[300px] lg:min-h-[250px] md:min-h-[230px] sm:min-h-[250px] min-h-[39.2vw]">
            <motion.div
              ...
              <img src="/assets/coding-gear-options-svgrepo-com.svg" className="w-[50%]" />
            </motion.div>
            <motion.div
              initial={{ scaleY: 0 }}
              animate={{ scaleY: 1 }}
            ...
            <motion.div
              ...
              <img src="/assets/processor.png" className="w-[50%]" />
            </motion.div>
            <motion.div
              initial={{ scaleY: 0 }}
              animate={{ scaleY: 1 }}
            ...
            <motion.div
              ...
              <img src="/assets/code.png" className="w-[50%]" />
            </motion.div>
            <motion.div
              initial={{ scaleY: 0 }}
              animate={{ scaleY: 1 }}
            ...
            <motion.div
              ...
              <img src="/assets/software-testing.png" className="w-[50%] " />
            </motion.div>
            <motion.div
              initial={{ scaleY: 0 }}
              animate={{ scaleY: 1 }}
            ...
            <motion.div
              ...
              <img src="/assets/react.svg" className="w-[50%]" />
            </motion.div>
            <motion.div
              initial={{ scaleY: 0 }}
              animate={{ scaleY: 1 }}
            ...
            <motion.div
              ...
              <img src="/assets/industrial.png" className="w-[50%] " />
            </motion.div>
            <motion.div
              initial={{ scaleY: 0 }}
              animate={{ scaleY: 1 }}
      ...
      <SoftwareProduct showHeader={true} />
      <OurServices />
      <Pricing showHeader={true} />
      <CaseStudies showHeader={true} />
      <StartYourJourney />
    </div>
  );
}
